# -*- coding: utf-8 -*-
"""Fake News Content Detection Kaggle Dataset LSTM and BERT.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1t8OckMeabhjo30F9Yuvb4Mw2SVS4aAGs
"""
...
true_df = raw_df.query("Labels == 5 or Labels == 3")
display(true_df)

fake_df = raw_df.query("Labels == 0 or Labels == 1")
display(fake_df)

"""## Real News Word Cloud"""

real_titles = true_df.Text
...
texts_len = []
for title in texts:
    texts_len.append(len(title.split()))
...
for epoch in range(NUM_EPOCHS):
    ...
    for batch_idx, data in enumerate(loop):
        ...
        outputs = model(input_ids=tokens_tensors[0:513], 
                        token_type_ids=segments_tensors[0:513], 
                        attention_mask=masks_tensors[0:513], 
                        labels=labels)
